...
def convert_image(
        source_path, destination_path, num_rows, num_cols, resize, horizontal_reflection,
        rotate_image, degree, gauss_noise, mean, std_dev, shear_horizontal, horizontal_factor,
        shear_vertical, vertical_factor, zero_padding, padding_dim, aspect, dimension, label_dict,
        print_every=100
    ):
...
if __name__ == "__main__":
    ...
    convert_image(
        train_path, train_destination_path, 1000, 500, False, False,
        False, 10, False, 50, 1, False, 0.2, False, 0.2, True, 600,
        True, 595, label_dict, print_every=500
        )
